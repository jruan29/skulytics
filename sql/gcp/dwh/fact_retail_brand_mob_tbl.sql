CREATE OR REPLACE TABLE `{{params.dwh_project}}.skulytics_DMART.fact_retail_brand_mob_tbl` AS
SELECT
  CONCAT(region_key, '#', retailer_key, '#', brand_key, '#', date_key) AS brand_mob_key,
  region_key,
  retailer_key,
  brand_key,
  date_key,
